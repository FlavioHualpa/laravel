   ...
   <form action="{{ route('admin.users.update', $user->id) }}" method="post">
      ...
      <div class="form-row">
         <div class="col-6">
            ...
            <input type="text" class="form-control form-control-lg font-weight-bold @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $user->name) }}">
            @error('name')
         ...
         <div class="col-6">
            ...
            <input type="email" class="form-control form-control-lg font-weight-bold @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email', $user->email) }}">
            @error('email')
            <p class="text-danger">{{ $message }}</p>
            @enderror
         </div>
      ...
      {{-- el campo oculto account_id necesario para modificar el usuario --}}
