...
use App\Rules\CompanyFieldUniqueRule;
...
class UpdateCompanyRequest extends FormRequest
{
   ...
   */
   ...
   {
      $company = $this->route()->parameters['company'];
      ...
      return [
         'code' => [
            ...
            'min:3',
            'max:12',
            new CompanyFieldUniqueRule('code', $company),
         ...
         'fiscal_id' => [
            ...
            new CompanyFieldUniqueRule('fiscal_id', $company),
            // Rule::unique('companies')->ignore($company),
         ],
