        ...
        <tr>
            <td style="width: 300px;">
                <div id="panel_izq">
					...
					<div id="boton_arreglos" class="div_selector_off" onclick="CambiarPagina('arreglos')">ARREGLOS CORALES</div>
            ...
            <td>
                ...
                <div id="pagina_transc" class="div_der" style="display: none">
                    ...
                    <ul id="obras_despres" style="display: none;">
                        <span class="esp_lista">&lt;&lt; Ver artículos sobre Josquin en la sección ARTÍCULOS MUSICOLÓGICOS</span>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="pdfs\portada_josquin.png">Portada original de la edición</a></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=27">Parfons regretz</a> a 5 (SSATB) - <em>(7* livre des chansons, Susato, Anvers, 1545)</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=41">Ie me complains</a> a 5 (SATTB) - <em>(7* livre des chansons, Susato, Anvers, 1545)</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=42">Cueur langoreux</a> a 5 (SATTB) - <em>(7* livre des chansons, Susato, Anvers, 1545)</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=56">Regretz sans fin</a> a 6 (SATTTB) - <em>(7* livre des chansons, Susato, Anvers, 1545, versión en el tono original)</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=43">Regretz sans fin</a> a 6 (SSAATB) - <em>(7* livre des chansons, Susato, Anvers, 1545, versión transpuesta para coro mixto)</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=47">En non saichant</a> a 5 (SATTB) - <em>(7* livre des chansons, Susato, Anvers, 1545, atribución en duda)</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=48">Je ne me puis tenir d'aimer</a> a 5 (SATTB) - <em>(36* Livre, XXX Chansons musicales, P. Attaingnant, Paris, 1549)</em></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=64">Cueurs desolez</a> a 5 (SATTB) - <em>(36* Livre, XXX Chansons musicales, P. Attaingnant, Paris, 1549)</em></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=69">Plus nulz regretz</a> a 4 (ATTB) - <em>(36* Livre, XXX Chansons musicales, P. Attaingnant, Paris, 1549)</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=52">Cueurs desolez</a> a 4 (STTB) - <em>(atribuida a Josquin y/o a Benedictus Appenzeller en diversas fuentes de época, entre ellas Attaingnant, 1534, Paris, versión en el tono original)</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=53">Cueurs desolez</a> a 4 (SATB) - <em>(atribuida a Josquin y/o a Benedictus Appenzeller en diversas fuentes de época, entre ellas Attaingnant, 1534, Paris, versión para coro mixto)</em></li>
                    </ul>
                    <br /><br />
                    ...
                    <ul id="obras_cornet" style="display: none;">
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="pdfs\Severin Cornet.pdf">Biografía</a></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="pdfs\portada_cornet.png">Portada original de la edición</a></li>
						...
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=54">O Lucia (parte 1)</a></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=55">O Lucia (parte 2)</a></li>
                    </ul>
                    <br /><br />
                    ...
                    <ul id="obras_danola" style="display: none;">
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="pdfs\Giovanni Domenico.pdf">Biografía y comentarios</a></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="pdfs\portada_nola.png">Portada original de la edición</a></li>
                    ...
                    <ul id="obras_lassus" style="display: none;">
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="pdfs\Portada Lassus.pdf">Portada de la Mellange de Orlande de Lassus</a></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=14">Dessus le marche</a> - <em>(Continuation du Mellange d'Orlande de Lassus, Le Roy & Ballard, 1584, París)</em></li>
						...
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=21">La morre est jeu</a> - <em>(Chanson, Mellange d'Orlande de Lassus, París, 1570, Le Roy & Ballard)</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=16">En espoir vis</a> - <em>(Chanson, Mellange d'Orlande de Lassus, París, 1570, Le Roy & Ballard)</em></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=92">Du cors absent</a> - <em>(Chanson, Mellange d'Orlande de Lassus, París, 1570, Le Roy & Ballard)</em><span class="etiqueta_nuevo">NUEVO</span></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=93">Un avocat dit a sa femme</a> - <em>(Chanson, Mellange d'Orlande de Lassus, París, 1570, Le Roy & Ballard)</em><span class="etiqueta_nuevo">NUEVO</span></li>
                    </ul>
                    <br /><br />
                    ...
                    <ul id="obras_francesas" style="display: none;">
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=87">Fyez vous y si vous voulez</a> - <em>(Clement Janequin (ca. 1485-1558), 26 Chansons a 4 parties, Attaingnant 1534, Paris)</em><span class="etiqueta_nuevo">NUEVO</span></li>
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=88">Rigueur me tient</a> - <em>(Claudin de Sermisy, ed 18* livre des chansons, Attaingnant, Paris 1545)</em><span class="etiqueta_nuevo">NUEVO</span></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=89">Ie n'ay point plus</a> - <em>(Claudin de Sermisy, ed 18* livre des chansons, Attaingnant, Paris 1545)</em><span class="etiqueta_nuevo">NUEVO</span></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=90">Il n'est que d'estre sur l'herbette</a> - <em>(Claude Gervaise, 16* livre des chansons, N. du Chemin, Paris 1550)</em><span class="etiqueta_nuevo">NUEVO</span></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=91">Perdre le sens devant vous</a> - <em>(Claude le Jeune, Le Printemps, R. Ballard, Paris 1603)</em><span class="etiqueta_nuevo">NUEVO</span></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=46">Es tu bien malade</a> - <em>(Anónimo, 27 chansons musicales, P. Attaingnant, Paris, 1534)</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=44">De trop aymer</a> - <em>(Anónimo, 27 chansons musicales, P. Attaingnant, Paris, 1534)</em></li>
                    </ul>
                    <br /><br />

                    <p class="titulo_panel">MADRIGALES Y VILLANELLE ITALIANAS DE DIVERSOS AUTORES&nbsp;&nbsp;<img id="carpeta_italianas" src="img/carpeta.png" alt="carpeta" height="24" style="vertical-align: middle; cursor: pointer;" onclick="AlternarCarpeta('italianas')" /></p><br />
                    <ul id="obras_italianas" style="display: none;">
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=57">Quando per mio destin</a> - <em>(Nicolo Vicentino, 5* libro de madrigales, 1572)</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=58">Vecchie letrose</a> - <em>(Adrian Willaert, Canzone villanesche, ed. A. Gardane, Venecia, 1545)</em></li>
                    </ul>
                    <br /><br />
                    ...
                    <ul id="obras_españolas" style="display: none;">
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=75">Teresica hermana</a> - <em>(Atribuida a Mateo Flecha, Cancionero de Uppsala (ed. 1556))</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=76">Las tristesas no me espantan</a> - <em>(Anónimo, Cancionero Musical de Palacio (ca. 1470-1520))</em><span class="etiqueta_nuevo">NUEVO</span></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=77">Gasajemonos de husía</a> - <em>(Juan del Encina, Cancionero Musical de Palacio (ca. 1470-1520))</em><span class="etiqueta_nuevo">NUEVO</span></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=78">Quédate carillo adiós</a> - <em>(Juan del Encina, Cancionero Musical de Palacio (ca. 1470-1520))</em><span class="etiqueta_nuevo">NUEVO</span></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=79">Todo mi bien e perdido</a> - <em>(Juan Ponce, Cancionero Musical de Palacio (ca. 1470-1520))</em><span class="etiqueta_nuevo">NUEVO</span></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=80">Si la noche haze escura</a> - <em>(Anónimo, Cancionero de Uppsala (ed. 1556))</em><span class="etiqueta_nuevo">NUEVO</span></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=81">Ojos garços a la niña</a> - <em>(Anónimo, Cancionero de Uppsala (ed. 1556))</em><span class="etiqueta_nuevo">NUEVO</span></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=82">Corten espadas afiladas</a> - <em>(Anónimo, Cancionero de Medinaceli (ca. 1540-70))</em><span class="etiqueta_nuevo">NUEVO</span></li>
                    </ul>
                    <br /><br />
                    ...
                    <ul id="obras_artmus" style="display: none;">
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; vertical-align: middle" /><a target="_blank" href="pdfs\Damus Nro 433.pdf">Entre dos mansos arroyos, madrigal español de comienzos del XVII, revista digital 433 del Damus-UNA, 2012</a></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; vertical-align: middle" /><a target="_blank" href="pdfs\Cantata 1994.pdf">Acercándonos a Palestrina y Lassus, revista Cantata, 1994</a></li>
                    </ul>
                    <br /><br />
                    -->
                </div>
                ...
                <div id="pagina_articulos" class="div_der" style="display: none">
                    ...
                    <ul id="obras_artmus">
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="pdfs\Josquin des Pres.pdf">Josquin Desprez - Comentario musicológico</a> (Parte I)</li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="pdfs\Los estilos de Josquin.pdf">Los estilos de las chansons de Josquin Desprez</a> (Parte II)<span class="etiqueta_nuevo">NUEVO</span></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; vertical-align: middle" /><a target="_blank" href="pdfs\Damus Nro 433.pdf">Entre dos mansos arroyos, madrigal español de comienzos del XVII, revista digital 433 del Damus-UNA, 2012</a></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; vertical-align: middle" /><a target="_blank" href="pdfs\Cantata 1994.pdf">Acercándonos a Palestrina y Lassus, revista Cantata, 1994</a></li>
                        <li>&nbsp;</li>
				...
				<div id="pagina_arreglos" class="div_der" style="display: none">
                    ...
                    <ul id="obras_mewalsh">
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=73">Como la cigarra</a> - <em>SATB (M. E. Walsh, 1982)</em></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=71">La canción del Jacarandá</a> - <em>SA / coro de niños (M. E. Walsh, 2018)</em></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=70">La vaca estudiosa</a> - <em>SA / coro de niños (M. E. Walsh, 2009)</em></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=68">Manuelita la tortuga</a> - <em>SA / coro de niños (M. E. Walsh, 2017)</em></li>
                    ...
                    <p class="titulo_panel">THE BEATLES</p><br>
                    <ul id="obras_beatles">
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=74">I wanna be your man</a> - <em>SATB y orquesta (Lennon-McCartney, 2007)</em></li>
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=65">I will</a> - <em>SATB y orquesta (P. Mc Cartney, 2006)</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=22">Lady Madonna</a> - <em>SATB y orquesta (Lennon-Mc Cartney, 2006)</em></li>
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=66">Yesterday</a> - <em>SATB y orquesta (P. Mc Cartney, 2006)</em></li>
                    </ul>
                    <br><br>
                    ...
                    <ul id="obras_folklore">
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=72">Atacama tierra mía</a> - <em>SATB (Iván Darrigrande, Curso de Arreglos Corales, Copiapó, Chile 2015)</em></li>
						...
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=45">Despertar de mi tierra</a> - <em>SATB (G. Morales - S.O'Brian, Curso de Arreglos Corales, Copiapó, Chile 2015)</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=86">El árbol ya fue plantado</a> - <em>SATB (E. Siro - D. Sánchez, 1991)</em> <img src="img/award-icon.png" class="icono-premio"><span class="etiqueta_nuevo">NUEVO</span></li>
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=23">Love of my life</a> - <em>SATB y orquesta (F. Mercury, 2006)</em></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=83">Palito de tola</a> - <em>SATB (René Vargas Vera - Luis Sánchez Vera, 1996)</em><span class="etiqueta_nuevo">NUEVO</span></li>
                    ...
                    <ul id="obras_spirituals">
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=84">Mary had a baby</a> - <em>SATB (Spiritual, 2000)</em><span class="etiqueta_nuevo">NUEVO</span></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=85">Oh yes</a> - <em>SATB solos y SATB (Spiritual, 1982)</em><span class="etiqueta_nuevo">NUEVO</span></li>
                    </ul>
                    <br><br>

                    <p class="titulo_panel">OTRAS</p><br>
                    <ul id="obras_otras">
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=17">Exaudiat te Dominus</a> - <em>SATB (N. Zadoff, obra original, 2009)</em> <img src="img/award-icon.png" class="icono-premio"></li>
                    </ul>
                    <br><br>
                </div>
