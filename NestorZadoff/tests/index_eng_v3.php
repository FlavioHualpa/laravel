            ...
            <td>
                ...
                <div id="pagina_transc" class="div_der" style="display: none">
                    ...
                    <ul id="obras_despres" style="display: none;">
						...
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=27">Parfons regretz</a> in 5 (SSATB) - <em>(7* livre des chansons, Susato, Anvers, 1545)</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=41">Ie me complains</a> in 5 (SATTB) - <em>(7* livre des chansons, Susato, Anvers, 1545)</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=42">Cueur langoreux</a> in 5 (SATTB) - <em>(7* livre des chansons, Susato, Anvers, 1545)</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=56">Regretz sans fin</a> in 6 (SATTTB) - <em>(7* livre des chansons, Susato, Anvers, 1545, original tone version)</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=43">Regretz sans fin</a> in 6 (SSAATB) - <em>(7* livre des chansons, Susato, Anvers, 1545, transposed version for mixed choir)</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=47">En non saichant</a> in 5 (SATTB) - <em>(7* livre des chansons, Susato, Anvers, 1545, dubious attribution)</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=48">Je ne me puis tenir d'aimer</a> in 5 (SATTB) - <em>(36* Livre, XXX Chansons musicales, P. Attaingnant, Paris, 1549)</em></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=64">Cueurs desolez</a> in 5 (SATTB) - <em>(36* Livre, XXX Chansons musicales, P. Attaingnant, Paris, 1549)</em></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=69">Plus nulz regretz</a> in 4 (ATTB) - <em>(36* Livre, XXX Chansons musicales, P. Attaingnant, Paris, 1549)</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=52">Cueurs desolez</a> in 4 (STTB) - <em>(attributed to Josquin and/or Benedictus Appenzeller in various period sources, including Attaingnant, 1534, Paris, original tone version)</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=53">Cueurs desolez</a> in 4 (SATB) - <em>(attributed to Josquin and/or Benedictus Appenzeller in various period sources, including Attaingnant, 1534, Paris, transposed version for mixed choir)</em></li>
                    </ul>
                    <br><br>
                    ...
                    <ul id="obras_cornet" style="display: none;">
						...
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=54">O Lucia (part 1)</a></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=55">O Lucia (part 2)</a></li>
                    </ul>
                    <br><br>
                    ...
                    <ul id="obras_francesas" style="display: none;">
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=88">Rigueur me tient</a> - <em>(Claudin de Sermisy, ed 18* livre des chansons, Attaingnant, Paris 1545)</em><span class="etiqueta_nuevo">NEW</span></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=89">Ie n'ay point plus</a> - <em>(Claudin de Sermisy, ed 18* livre des chansons, Attaingnant, Paris 1545)</em><span class="etiqueta_nuevo">NEW</span></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=90">Il n'est que d'estre sur l'herbette</a> - <em>(Claude Gervaise, 16* livre des chansons, N. du Chemin, Paris 1550)</em><span class="etiqueta_nuevo">NEW</span></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=91">Perdre le sens devant vous</a> - <em>(Claude le Jeune, Le Printemps, R. Ballard, Paris 1603)</em><span class="etiqueta_nuevo">NEW</span></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=46">Es tu bien malade</a> - <em>(Anonymous, 27 chansons musicales, P. Attaingnant, Paris, 1534)</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=44">De trop aymer</a> - <em>(Anonymous, 27 chansons musicales, P. Attaingnant, Paris, 1534)</em></li>
                    </ul>
                    <br><br>
                    ...
                    <ul id="obras_italianas" style="display: none;">
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=57">Quando per mio destin</a> - <em>(Nicolo Vicentino, 5th book of madrigals, 1572)</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=58">Vecchie letrose</a> - <em>(Adrian Willaert, Canzone villanesche, ed. A. Gardane, Venice, 1545)</em></li>
                    </ul>
                    <br><br>
                    ...
                    <ul id="obras_españolas" style="display: none;">
						...
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=79">Todo mi bien e perdido</a> - <em>(Juan Ponce, Cancionero Musical de Palacio (ca. 1470-1520))</em><span class="etiqueta_nuevo">NEW</span></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=80">Si la noche haze escura</a> - <em>(Anonymous, Cancionero de Uppsala (ed. 1556))</em><span class="etiqueta_nuevo">NEW</span></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=81">Ojos garços a la niña</a> - <em>(Anonymous, Cancionero de Uppsala (ed. 1556))</em><span class="etiqueta_nuevo">NEW</span></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=82">Corten espadas afiladas</a> - <em>(Anonymous, Cancionero de Medinaceli (ca. 1540-70))</em><span class="etiqueta_nuevo">NEW</span></li>
                    </ul>
                    <br><br>
				...
				<div id="pagina_arreglos" class="div_der" style="display: none">
                    ...
                    <ul id="obras_mewalsh">
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=71">La canción del Jacarandá</a> - <em>SA / children's choir (M. E. Walsh, 2018)</em></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=70">La vaca estudiosa</a> - <em>SA / children's choir (M. E. Walsh, 2009)</em></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=68">Manuelita la tortuga</a> - <em>SA / children's choir (M. E. Walsh, 2017)</em></li>
                    ...
                    <ul id="obras_beatles">
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=74">I wanna be your man</a> - <em>SATB and orchestra (Lennon-McCartney, 2007)</em></li>
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=65">I will</a> - <em>SATB and orchestra (P. Mc Cartney, 2006)</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=22">Lady Madonna</a> - <em>SATB and orchestra (Lennon-Mc Cartney, 2006)</em></li>
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=66">Yesterday</a> - <em>SATB and orchestra (P. Mc Cartney, 2006)</em></li>
                    </ul>
                    <br><br>
                    ...
                    <ul id="obras_folklore">
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=72">Atacama tierra mía</a> - <em>SATB (Choral arrangements workshop, Copiapó, Chile 2015)</em></li>
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=86">El árbol ya fue plantado</a> - <em>SATB (E. Siro - D. Sánchez, 1991)</em> <img src="img/award-icon.png" class="icono-premio"><span class="etiqueta_nuevo">NEW</span></li>
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=23">Love of my life</a> - <em>SATB and orchestra (F. Mercury, 2006)</em></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=83">Palito de tola</a> - <em>SATB (René Vargas Vera - Luis Sánchez Vera, 1996)</em><span class="etiqueta_nuevo">NEW</span></li>
                    ...
                    <ul id="obras_spirituals">
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=84">Mary had a baby</a> - <em>SATB (Spiritual, 2000)</em><span class="etiqueta_nuevo">NEW</span></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=85">Oh yes</a> - <em>Solo SATB and SATB (Spiritual, 1982)</em><span class="etiqueta_nuevo">NEW</span></li>
                    </ul>
                    <br><br>

                    <p class="titulo_panel">OTHER</p><br>
                    <ul id="obras_otras">
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=17">Exaudiat te Dominus</a> - <em>SATB (N. Zadoff, original work, 2009)</em> <img src="img/award-icon.png" class="icono-premio"></li>
                    </ul>
                    <br><br>
                </div>
