            ...
            <td>
                ...
                <div id="pagina_transc" class="div_der" style="display: none">
                    ...
                    <ul id="obras_despres" style="display: none;">
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=69">Plus nulz regretz</a> in 4 (ATTB) - <em>(36* Livre, XXX Chansons musicales, P. Attaingnant, Paris, 1549)</em><span class="etiqueta_nuevo">NEW</span></li>
				...
				<div id="pagina_arreglos" class="div_der" style="display: none">
                    ...
                    <ul>
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=72">Atacama tierra mía</a> - <em>SATB (Course on Choral Arrangements, Copiapó, Chile 2015)</em><span class="etiqueta_nuevo">NEW</span></li>
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=73">Como la cigarra</a> - <em>SATB (M. E. Walsh, 1982)</em><span class="etiqueta_nuevo">NEW</span></li>
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=74">I wanna be your man</a> - <em>SATB and orchestra (Lennon-McCartney, 2007)</em><span class="etiqueta_nuevo">NEW</span></li>
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=71">La canción del Jacarandá</a> - <em>SA / children's choir (M. E. Walsh, 2018)</em><span class="etiqueta_nuevo">NEW</span></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=70">La vaca estudiosa</a> - <em>SA / children's choir (M. E. Walsh, 2009)</em><span class="etiqueta_nuevo">NEW</span></li>
