            ...
            <td>
                ...
                <div id="pagina_transc" class="div_der" style="display: none">
                    ...
                    <ul id="obras_despres" style="display: none;">
						...
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a href="#" onclick="AbrirDescarga('id=27');">Parfons regretz</a> a 5 (SSATB) - <em>(7* livre des chansons, Susato, Anvers, 1545)</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a href="#" onclick="AbrirDescarga('id=41');">Ie me complains</a> a 5 (SATTB) - <em>(7* livre des chansons, Susato, Anvers, 1545)</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a href="#" onclick="AbrirDescarga('id=42');">Cueur langoreux</a> a 5 (SATTB) - <em>(7* livre des chansons, Susato, Anvers, 1545)</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a href="#" onclick="AbrirDescarga('id=56');">Regretz sans fin</a> a 6 (SATTTB) - <em>(7* livre des chansons, Susato, Anvers, 1545, versión en el tono original)</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a href="#" onclick="AbrirDescarga('id=43');">Regretz sans fin</a> a 6 (SSAATB) - <em>(7* livre des chansons, Susato, Anvers, 1545, versión transpuesta para coro mixto)</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a href="#" onclick="AbrirDescarga('id=47');">En non saichant</a> a 5 (SATTB) - <em>(7* livre des chansons, Susato, Anvers, 1545, atribución en duda)</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a href="#" onclick="AbrirDescarga('id=48');">Je ne me puis tenir d'aimer</a> a 5 (SATTB) - <em>(36* Livre, XXX Chansons musicales, P. Attaingnant, Paris, 1549)</em></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a href="#" onclick="AbrirDescarga('id=64');">Cueurs desolez</a> a 5 (SATTB) - <em>(36* Livre, XXX Chansons musicales, P. Attaingnant, Paris, 1549)</em></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a href="#" onclick="AbrirDescarga('id=69');">Plus nulz regretz</a> a 4 (ATTB) - <em>(36* Livre, XXX Chansons musicales, P. Attaingnant, Paris, 1549)</em><span class="etiqueta_nuevo">NUEVO</span></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a href="#" onclick="AbrirDescarga('id=52');">Cueurs desolez</a> a 4 (STTB) - <em>(atribuida a Josquin y/o a Benedictus Appenzeller en diversas fuentes de época, entre ellas Attaingnant, 1534, Paris, versión en el tono original)</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a href="#" onclick="AbrirDescarga('id=53');">Cueurs desolez</a> a 4 (SATB) - <em>(atribuida a Josquin y/o a Benedictus Appenzeller en diversas fuentes de época, entre ellas Attaingnant, 1534, Paris, versión para coro mixto)</em></li>
                    </ul>
                    <br /><br />
                    ...
                    <ul id="obras_cornet" style="display: none;">
						...
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a href="#" onclick="AbrirDescarga('id=54');">O Lucia (parte 1)</a></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a href="#" onclick="AbrirDescarga('id=55');">O Lucia (parte 2)</a></li>
                    </ul>
                    <br /><br />
                    ...
                    <ul id="obras_lassus" style="display: none;">
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a href="#" onclick="AbrirDescarga('id=14');">Dessus le marche</a> - <em>(Continuation du Mellange d'Orlande de Lassus, Le Roy & Ballard, 1584, París)</em></li>
						...
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a href="#" onclick="AbrirDescarga('id=21');">La morre est jeu</a> - <em>(Chanson, Mellange d'Orlande de Lassus, París, 1570, Le Roy & Ballard)</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a href="#" onclick="AbrirDescarga('id=16');">En espoir vis</a> - <em>(Chanson, Mellange d'Orlande de Lassus, París, 1570, Le Roy & Ballard)</em></li>
                    </ul>
                    <br /><br />

                    <p class="titulo_panel">CHANSONS FRANCESAS DE DIVERSOS AUTORES&nbsp;&nbsp;<img id="carpeta_francesas" src="img/carpeta.png" alt="carpeta" height="24" style="vertical-align: middle; cursor: pointer;" onclick="AlternarCarpeta('francesas')" /></p><br />
                    <ul id="obras_francesas" style="display: none;">
						...
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a href="#" onclick="AbrirDescarga('id=46');">Es tu bien malade</a> - <em>(Anónimo, 27 chansons musicales, P. Attaingnant, Paris, 1534)</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a href="#" onclick="AbrirDescarga('id=44');">De trop aymer</a> - <em>(Anónimo, 27 chansons musicales, P. Attaingnant, Paris, 1534)</em></li>
                    </ul>
                    <br /><br />
                    ...
                    <ul id="obras_italianas" style="display: none;">
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a href="#" onclick="AbrirDescarga('id=57');">Quando per mio destin</a> - <em>(Nicolo Vicentino, 5* libro de madrigales, 1572)</em></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a href="#" onclick="AbrirDescarga('id=58');">Vecchie letrose</a> - <em>(Adrian Willaert, Canzone villanesche, ed. A. Gardane, Venecia, 1545)</em></li>
                    </ul>
                    <br /><br />

                    <p class="titulo_panel">MADRIGALES Y VILLANCICOS ESPAÑOLES DE DIVERSOS AUTORES&nbsp;&nbsp;<img id="carpeta_españolas" src="img/carpeta.png" alt="carpeta" height="24" style="vertical-align: middle; cursor: pointer;" onclick="AlternarCarpeta('españolas')" /></p><br />
                    <ul id="obras_españolas" style="display: none;">
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a href="#" onclick="AbrirDescarga('id=75');">Teresica hermana</a> - <em>(Atribuida a Mateo Flecha, Cancionero de Uppsala, 1556)</em><span class="etiqueta_nuevo">NUEVO</span></li>
                    </ul>
                    <br /><br />
				...
				<div id="pagina_arreglos" class="div_der" style="display: none">
                    ...
                    <p class="texto_lista_panel">• El árbol ya fue plantado (SATB) IV Premio Canción (Nacional 1985)</p>
                    ...
                    <ul>
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a href="#" onclick="AbrirDescarga('id=72');">Atacama tierra mía</a> - <em>SATB (Curso de Arreglos Corales, Copiapó, Chile 2015)</em><span class="etiqueta_nuevo">NUEVO</span></li>
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a href="#" onclick="AbrirDescarga('id=73');">Como la cigarra</a> - <em>SATB (M. E. Walsh, 1982)</em><span class="etiqueta_nuevo">NUEVO</span></li>
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a href="#" onclick="AbrirDescarga('id=17');">Exaudiat te Dominus</a> - <em>SATB (N. Zadoff, obra original, 2009)</em> <img src="img/award-icon.png" class="icono-premio"></li>
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a href="#" onclick="AbrirDescarga('id=74');">I wanna be your man</a> - <em>SATB y orquesta (Lennon-McCartney, 2007)</em><span class="etiqueta_nuevo">NUEVO</span></li>
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a href="#" onclick="AbrirDescarga('id=65');">I will</a> - <em>SATB y orquesta (P. Mc Cartney, 2006)</em></li>
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a href="#" onclick="AbrirDescarga('id=71');">La canción del Jacarandá</a> - <em>SA / coro de niños (M. E. Walsh, 2018)</em><span class="etiqueta_nuevo">NUEVO</span></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a href="#" onclick="AbrirDescarga('id=70');">La vaca estudiosa</a> - <em>SA / coro de niños (M. E. Walsh, 2009)</em><span class="etiqueta_nuevo">NUEVO</span></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a href="#" onclick="AbrirDescarga('id=22');">Lady Madonna</a> - <em>SATB y orquesta (Lennon-Mc Cartney, 2006)</em></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a href="#" onclick="AbrirDescarga('id=23');">Love of my life</a> - <em>SATB y orquesta (F. Mercury, 2006)</em></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a href="#" onclick="AbrirDescarga('id=68');">Manuelita la tortuga</a> - <em>SA / coro de niños (M. E. Walsh, 2017)</em></li>
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a href="#" onclick="AbrirDescarga('id=66');">Yesterday</a> - <em>SATB y orquesta (P. Mc Cartney, 2006)</em></li>
