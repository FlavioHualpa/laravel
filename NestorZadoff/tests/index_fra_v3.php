            ...
            <td>
                ...
                <div id="pagina_transc" class="div_der" style="display: none">
                    ...
                    <span class="esp_lista">&lt;&lt; Pour voir les articles concernant Josquin aller à ARTICLES MUSICOLOGIQUES</span>
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=69">Plus nulz regretz</a> à 4 (ATTB) - <em>(36* Livre, XXX Chansons musicales, P. Attaingnant, Paris, 1549)</em></li>
                    ...
                    <ul id="obras_francesas" style="display: none;">
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=88">Rigueur me tient</a> - <em>(Claudin de Sermisy, ed 18* livre des chansons, Attaingnant, Paris 1545)</em><span class="etiqueta_nuevo">NOUVEAUTÉ</span></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=89">Ie n'ay point plus</a> - <em>(Claudin de Sermisy, ed 18* livre des chansons, Attaingnant, Paris 1545)</em><span class="etiqueta_nuevo">NOUVEAUTÉ</span></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=90">Il n'est que d'estre sur l'herbette</a> - <em>(Claude Gervaise, 16* livre des chansons, N. du Chemin, Paris 1550)</em><span class="etiqueta_nuevo">NOUVEAUTÉ</span></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=91">Perdre le sens devant vous</a> - <em>(Claude le Jeune, Le Printemps, R. Ballard, Paris 1603)</em><span class="etiqueta_nuevo">NOUVEAUTÉ</span></li>
                    ...
                    <ul id="obras_españolas" style="display: none;">
						...
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=79">Todo mi bien e perdido</a> - <em>(Juan Ponce, Cancionero Musical de Palacio (ca. 1470-1520))</em><span class="etiqueta_nuevo">NOUVEAUTÉ</span></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=80">Si la noche haze escura</a> - <em>(Anonyme, Cancionero de Uppsala (ed. 1556))</em><span class="etiqueta_nuevo">NOUVEAUTÉ</span></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=81">Ojos garços a la niña</a> - <em>(Anonyme, Cancionero de Uppsala (ed. 1556))</em><span class="etiqueta_nuevo">NOUVEAUTÉ</span></li>
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=82">Corten espadas afiladas</a> - <em>(Anonyme, Cancionero de Medinaceli (ca. 1540-70))</em><span class="etiqueta_nuevo">NOUVEAUTÉ</span></li>
                    </ul>
                    <br /><br />
				...
				<div id="pagina_arreglos" class="div_der" style="display: none">
                    ...
                    <ul id="obras_mewalsh">
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=71">La canción del Jacarandá</a> - <em>SA / chœur d'enfants (M. E. Walsh, 2018)</em></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=70">La vaca estudiosa</a> - <em>SA / chœur d'enfants (M. E. Walsh, 2009)</em></li>
                    ...
                    <ul id="obras_beatles">
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=74">I wanna be your man</a> - <em>SATB et orchestre (Lennon-McCartney, 2007)</em></li>
                    ...
                    <ul id="obras_folklore">
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=72">Atacama tierra mía</a> - <em>SATB (Iván Darrigrande, Stage d'arrangements choraux, Copiapó, Chili 2015)</em></li>
						...
						<li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=45">Despertar de mi tierra</a> - <em>SATB (G. Morales - S.O'Brian, Stage d'arrangements choraux, Copiapó, Chili 2015)</em></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=86">El árbol ya fue plantado</a> - <em>SATB (E. Siro - D. Sánchez, 1991)</em> <img src="img/award-icon.png" class="icono-premio"><span class="etiqueta_nuevo">NOUVEAUTÉ</span></li>
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=83">Palito de tola</a> - <em>SATB (René Vargas Vera - Luis Sánchez Vera, 1996)</em><span class="etiqueta_nuevo">NOUVEAUTÉ</span></li>
                    ...
                    <ul id="obras_spirituals">
                        ...
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=84">Mary had a baby</a> - <em>SATB (Spiritual, 2000)</em><span class="etiqueta_nuevo">NOUVEAUTÉ</span></li>
                        <li class="link_panel"><img src="img/acrobat_icon.png" width="24" height="24" style="margin-left: 30px; margin-right: 10px; margin-bottom: 4px; vertical-align: middle" /><a target="_blank" href="displaypdf.php?id=85">Oh yes</a> - <em>Soliste SATB et SATB (Spiritual, 1982)</em><span class="etiqueta_nuevo">NOUVEAUTÉ</span></li>
                    </ul>
                    <br><br>
